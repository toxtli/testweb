...
$("#Areas_research_1").click(function () {
    //animate html body and use jQuery scrollTop
    $('html, body').animate({
        scrollTop: $("#Areas_research_11").offset().top
    }, 1000);
});

$("#Areas_research_2").click(function () {
    //animate html body and use jQuery scrollTop
    $('html, body').animate({
        scrollTop: $("#Areas_research_22").offset().top -20
    }, 1000);
});
$("#Areas_research_3").click(function () {
    //animate html body and use jQuery scrollTop
    $('html, body').animate({
        scrollTop: $("#Areas_research_33").offset().top -20
    }, 1000);
});
$("#Areas_research_4").click(function () {
    //animate html body and use jQuery scrollTop
    $('html, body').animate({
        scrollTop: $("#Areas_research_44").offset().top -20
    }, 1000);
});
